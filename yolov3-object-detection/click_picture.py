...
# if there is 1 ms of delay in the frame rate then the camera automatically stops
# press q to release camera from operating
...
if cv2.waitKey(1) & 0xFF == ord('q'):
    vid.release()
# destroy the opencv window after the camera release
